        ...
        <>
            ...
            <Section>
                ...
                <div className="max-w-[600px] w-full mx-auto px-6 lg:px-0 text-center mt-16 ">
                    ...
                    SOS Villages d’Enfants traite vos données personnelles en toute confidentialité: Vos données sont cryptées et transférées via une liaison SSL. Notre système de paiement est sécurisé par 3-D Secure (MasterCard Secure Code et Verified by VISA)
                </div>
            </Section>
        </>
    )
